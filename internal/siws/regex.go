...
const _SIWE_DOMAIN = "(?P<domain>([^/?#]+)) wants you to sign in with your Solana account:\\n"

const _SIWE_ADDRESS = "(?P<address>[A-HJ-NP-Za-km-z1-9]{44})\\n\\n"
...
const _SIWE_CHAIN_ID = "Chain ID: (?P<chainId>((solana:)?)((mainnet)|(testnet)|(devnet)|(localnet)))\\n"
